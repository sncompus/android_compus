...
import com.compus.account.AccountActivity;
import com.compus.function.FunctionActivity;
import com.compus.home.HomeActivity;
import com.compus.more.MoreActivity;
import com.compus.near.NearActivity;
...
public class MainActivity extends TabActivity implements OnClickListener {
	...
	public static String TAB_TAG_FUNCTION = "function";
	...
	Intent mHomeItent, mChannelIntent, mAccountIntent,mNearIntent,
			mMoreIntent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (Utils.hasBind(getApplicationContext()) && !PushManager.isPushEnabled(getApplicationContext())) {
	...
	private void prepareIntent() {
		...
		mNearIntent = new Intent(this, NearActivity.class);
		mChannelIntent = new Intent(this, FunctionActivity.class);
	...
	private void setupIntent() {
		...
		mTabHost.addTab(buildTabSpec(TAB_TAG_NEAR, R.string.category_near,
				R.drawable.icon_1_n, mNearIntent));
		mTabHost.addTab(buildTabSpec(TAB_TAG_FUNCTION,
	...
	public void onClick(View v) {
		...
		mBut2.setImageResource(R.drawable.icon_1_n);
		mBut3.setImageResource(R.drawable.icon_4_n);
		mBut4.setImageResource(R.drawable.icon_2_n);
		...
		case R.id.channel1:
			...
			break;
		case R.id.channel2:
			mTabHost.setCurrentTabByTag(TAB_TAG_NEAR);
			mBut2.setImageResource(R.drawable.icon_1_c);
			mCateText2.setTextColor(COLOR2);
			break;
		case R.id.channel3:
			mTabHost.setCurrentTabByTag(TAB_TAG_ACCOUNT);
			mBut3.setImageResource(R.drawable.icon_4_c);
			mCateText3.setTextColor(COLOR2);
			break;
		case R.id.channel4:
			mTabHost.setCurrentTabByTag(TAB_TAG_FUNCTION);
			mBut4.setImageResource(R.drawable.icon_2_c);
